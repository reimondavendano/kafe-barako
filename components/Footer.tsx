            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <div className="flex gap-4 mt-4">
                        <a
                            href="https://facebook.com/kafebarako"
                            target="_blank"
                        ...
                        <a
                            href="https://instagram.com/kafebarako"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F77737] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform"
